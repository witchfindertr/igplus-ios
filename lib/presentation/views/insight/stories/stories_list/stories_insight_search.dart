...
class StoriesInsightSearch extends StatefulWidget {
  const StoriesInsightSearch({
    Key? key,
    this.onChanged,
    this.debounceTime,
  ...
  @override
  _StoriesInsightSearchState createState() => _StoriesInsightSearchState();
}

class _StoriesInsightSearchState extends State<StoriesInsightSearch> {
