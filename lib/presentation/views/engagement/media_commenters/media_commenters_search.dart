...
class MediaCommentersSearch extends StatefulWidget {
  const MediaCommentersSearch({
    Key? key,
    this.onChanged,
    this.debounceTime,
  ...
  @override
  _MediaCommentersSearchState createState() => _MediaCommentersSearchState();
}

class _MediaCommentersSearchState extends State<MediaCommentersSearch> {
