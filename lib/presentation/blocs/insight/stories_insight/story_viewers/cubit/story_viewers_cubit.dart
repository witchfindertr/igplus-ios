...
class StoryViewersCubit extends Cubit<StoryViewersState> {
  ...
  Future<List<StoryViewer>?> getStoryViewersList(
      {required String mediaId, required String type, required int pageKey}) async {
    List<StoryViewer>? storyViewersList;
    storyViewersList = await _getStoryViewersListFromLocal(mediaId: mediaId, type: type, pageKey: pageKey);
  ...
  Future<List<StoryViewer>?> _getStoryViewersListFromLocal(
    ...
    final failureOrStoryViewersList =
        await getStoryViewersFromLocal.execute(boxKey: type, mediaId: mediaId, pageKey: pageKey);
